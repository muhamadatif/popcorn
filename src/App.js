...
export default function App() {
  ...
  const handleAddWatched = (movie) => {
    // setWatched((watched) => {
    //   const existingMovie = watched.find((el) => el.imdbID === movie.imdbID);
    //   const isExisted = watched.some((el) => el.imdbID === movie.imdbID);
    //   const isExistedSameRating = watched.some(
    //     (el) => el.imdbID === movie.imdbID && el.userRating === movie.userRating
    //   );
    //   console.log(existingMovie, isExisted, isExistedSameRating);
    //   if (!isExisted && !isExistedSameRating) {
    //     return [...watched, movie];
    //   } else if (isExisted && !isExistedSameRating) {
    //     existingMovie.userRating = movie.userRating;
    //     const filteredwatched = watched.filter(
    //       (el) => el.imdbID !== movie.imdbID
    //     );
    //     filteredwatched.push(existingMovie);
